...
public class EdUOCation extends Application {
     ...
     * Project's title.
     */
    private final static String TITLE = "EdUOCation | PRAC 2024-1";
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        stage.setTitle(EdUOCation.TITLE);
        goScene("main");
    }
    ...
    public void goScene(String view) throws IOException {
        ...
        try{
            URL resource = EdUOCation.class.getResource("/fxml/"+view+".fxml");
            if(resource == null){
                throw new Exception();
            }
